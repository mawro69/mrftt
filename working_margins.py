...
len(Ais1eq[0][0].to_list(Ais1eq[0][0]))
len(Ais1eq)

Ais1eq[6][2].shape
n
Ais1eq[1][3].to_list(Ais1eq[1][3])

for k in range (10) :
    print(Ais1eq[1][3].to_list(Ais1eq[1][3])[k].shape)
...
Bis1eq[0].to_list(Bis1eq[3])[1].shape


for k in range (10) :
    print(Bis1eq[0].to_list(Bis1eq[0])[k].shape)
