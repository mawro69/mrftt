...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan  6 14:08:22 2023
...
np.savetxt('/home/abouabdallah/Bureau/docurespres/article/D50nn'+ case +'.txt',D,fmt='%.2f')



np.savetxt('/home/abouabdallah/Bureau/docurespres/article/C50nn'+ case +'.txt',C,fmt='%.2f')



Ctest=np.loadtxt('/home/abouabdallah/Bureau/docurespres/article/C50nn'+ case +'.txt')
Dtest=np.loadtxt('/home/abouabdallah/Bureau/docurespres/article/D50nn'+ case +'.txt')
...
df.to_csv('/home/abouabdallah/Bureau/docurespres/article/Dfnn60'+case+'.csv')
...
ao=time.time()
aaa=comp_mar_mcmc.Lechant(n,q,dicu, dicb, Niter=100, L=1000)
ao2=time.time()
aaa
...
dfall.to_csv('/home/abouabdallah/Bureau/docurespres/article/Dfnn60'+case+'.csv')


df2all=visualisation.marginales_df2(uns,bins,res2, binaries, "TT", "Pf", "Gibbs")

df2all.to_csv('/home/abouabdallah/Bureau/docurespres/article/Dfnn60'+case+'bin.csv')
