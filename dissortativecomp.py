...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan  8 19:09:52 2023
...
unaries1
res
print(np.array(comp_mar_mcmc.app_classes(unaries1, n,q ))==C)
...
df2all=visualisation.marginales_df2(uns,lol,res2, binaries, "TT", "Pf", "Gibbs")
